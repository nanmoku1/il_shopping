...
Route::prefix('admin')->namespace('Admin')->as('admin.')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::get('admin_users/create', 'AdminUserController@create_page')->name('admin_users_create_page');
        Route::get('admin_users/{id}/edit', 'AdminUserController@edit_page')->name('admin_users_edit_page');
